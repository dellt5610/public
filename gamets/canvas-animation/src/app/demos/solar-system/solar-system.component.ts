...
export class SolarSystemComponent implements OnInit, AfterViewInit {
  ...
  draw(){
    ...
    this.context.translate(this.earthOrbitRadius, 0);
    //create shadow
    this.context.fillRect(0, -this.earthRadius , this.moonOrbitRadius + this.moonRadius, 2*this.earthRadius);
    // this.earth.onload = () => {
    ...
    this.context.translate(this.moonOrbitRadius, 0);
    this.context.drawImage(this.moon, -this.moonRadius, -this.moonRadius);
    this.context.restore();

    //draw earch orbit
    this.context.beginPath();
    this.context.arc(this.canvasWidth / 2, this.canvasHeight / 2, this.earthOrbitRadius, 0, 2 * Math.PI);
    this.context.stroke();
